...
Version  : 0.4.20
Release  : 35
URL      : https://github.com/ahupp/python-magic/archive/0.4.20/python-magic-0.4.20.tar.gz
Source0  : https://github.com/ahupp/python-magic/archive/0.4.20/python-magic-0.4.20.tar.gz
...
%prep
%setup -q -n python-magic-0.4.20
cd %{_builddir}/python-magic-0.4.20
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612292839
...
cp %{_builddir}/python-magic-0.4.20/LICENSE %{buildroot}/usr/share/package-licenses/python-magic/73475ea543961f243b327f5e39ba5fc038f9770c
