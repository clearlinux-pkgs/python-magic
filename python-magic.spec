...
Version  : 0.4.25
Release  : 51
URL      : https://github.com/ahupp/python-magic/archive/0.4.25/python-magic-0.4.25.tar.gz
Source0  : https://github.com/ahupp/python-magic/archive/0.4.25/python-magic-0.4.25.tar.gz
...
%prep
%setup -q -n python-magic-0.4.25
cd %{_builddir}/python-magic-0.4.25
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643996433
...
cp %{_builddir}/python-magic-0.4.25/LICENSE %{buildroot}/usr/share/package-licenses/python-magic/73475ea543961f243b327f5e39ba5fc038f9770c
