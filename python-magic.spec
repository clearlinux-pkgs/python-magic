...
Version  : 0.4.18
Release  : 31
URL      : https://github.com/ahupp/python-magic/archive/0.4.18/python-magic-0.4.18.tar.gz
Source0  : https://github.com/ahupp/python-magic/archive/0.4.18/python-magic-0.4.18.tar.gz
...
%prep
%setup -q -n python-magic-0.4.18
cd %{_builddir}/python-magic-0.4.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603409036
...
cp %{_builddir}/python-magic-0.4.18/LICENSE %{buildroot}/usr/share/package-licenses/python-magic/a41bd5874a0b11123afd74123d0b6766273decd7
